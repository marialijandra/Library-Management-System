...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Identify creator's role (hardcoded to Role.ADMIN for quick development/testing)
        ...
        // Executes registration logic and captures the boolean outcome
        ...
        if (isSuccess) {
            // Redirects to "register" (servlet GET) to cleanly reload the registration page inside /views/
